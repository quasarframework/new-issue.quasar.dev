const dialogText = {
  reproductionSteps: {
    ...
    message: `To start off, describe what it is you are trying to accomplish with Quasar.
...
Write EXACTLY what happened. Be sure to add stack traces or error messages. 
  ...
  api: {
    title: `Adding a Usage Example`,
    message: `
Try to formulate how the new feature would be used in code by a developer.
If you can't put it into some type of code format, you probably haven't thought about the idea enough.
      `
  },
  problem: {
